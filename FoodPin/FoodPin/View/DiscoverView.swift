...
struct DiscoverView: View {
    ...
    var body: some View {
        ...
        @State var discoverRestaurants: [Restaurant] = [
            ...
            Restaurant(name: "Upstate", type: "American", location: "95 1st Ave New York, NY 10003", phone: "343-233221", summary: "The absolute best seafood place in town. The atmosphere here creates a very homey feeling. We open at 5 PM, and close at 10:30 PM.", image: (UIImage(named: "upstate")?.pngData())!, isFavorite: false, canCreate: false, context: context),
